  ...
  return (
    <section className="max-w-7xl mx-auto">
        <div>
            ...
            <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Unleash your creativity with VisionCraft and share your breathtaking, imaginative images with our vibrant community.</p>
        </div>
        <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
            ...
            <div className="mt-10">
                ...
                After crafting your image, you can share it with the community to showcase your work.              
                </p>
                <button 
                  type="submit"
